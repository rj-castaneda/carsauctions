...
namespace AuctionService.Data
{
    public class DbInitializer
    {
        ...
        {
            // add using keyword to allow the frameworka once we are finished with
            // the method to dispose of any of the services we used inside the scope created
        ...
        {
            // now we can use context to talk to database
            // Create database if not existing and apply any pending migrations
            context.Database.Migrate();

            // Do not seed if database already has data
            ...
            // EF will keep auctions in memory when we AddRange
